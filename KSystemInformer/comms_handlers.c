...
KPHM_DEFINE_HANDLER(KphpCommsEscalateHandle);
KPHM_DEFINE_HANDLER(KphpCommsWriteVirtualMemory);
...
const KPH_MESSAGE_HANDLER KphCommsMessageHandlers[] = {
    ...
    {KphMsgGetInformerSettings, KphpCommsGetInformerSettings,
     KphpCommsRequireLow},
    {KphMsgSetInformerSettings, KphpCommsSetInformerSettings,
     KphpCommsRequireLow},
    {KphMsgOpenProcess, KphpCommsOpenProcess, KphpCommsOpenProcessRequires},
    {KphMsgOpenProcessToken, KphpCommsOpenProcessToken,
     KphpCommsOpenProcessTokenRequires},
    {KphMsgOpenProcessJob, KphpCommsOpenProcessJob,
     KphpCommsOpenProcessJobRequires},
    {KphMsgTerminateProcess, KphpCommsTerminateProcess,
     KphpCommsRequireMaximum},
    {KphMsgReadVirtualMemory, KphpCommsReadVirtualMemory,
     KphpCommsRequireMaximum},
    {KphMsgOpenThread, KphpCommsOpenThread, KphpCommsOpenThreadRequires},
    {KphMsgOpenThreadProcess, KphpCommsOpenThreadProcess,
     KphpCommsOpenThreadProcessRequires},
    {KphMsgCaptureStackBackTraceThread, KphpCommsCaptureStackBackTraceThread,
     KphpCommsRequireMedium},
    {KphMsgEnumerateProcessHandles, KphpCommsEnumerateProcessHandles,
     KphpCommsRequireMedium},
    {KphMsgQueryInformationObject, KphpCommsQueryInformationObject,
     KphpCommsRequireMedium},
    {KphMsgSetInformationObject, KphpCommsSetInformationObject,
     KphpCommsRequireMaximum},
    {KphMsgOpenDriver, KphpCommsOpenDriver, KphpCommsRequireMaximum},
    {KphMsgQueryInformationDriver, KphpCommsQueryInformationDriver,
     KphpCommsRequireMaximum},
    {KphMsgQueryInformationProcess, KphpCommsQueryInformationProcess,
     KphpCommsQueryInformationProcessRequires},
    {KphMsgSetInformationProcess, KphpCommsSetInformationProcess,
     KphpCommsRequireMaximum},
    {KphMsgSetInformationThread, KphpCommsSetInformationThread,
     KphpCommsRequireMaximum},
    {KphMsgSystemControl, KphpCommsSystemControl, KphpCommsRequireMaximum},
    {KphMsgAlpcQueryInformation, KphpCommsAlpcQueryInformation,
     KphpCommsRequireMedium},
    {KphMsgQueryInformationFile, KphpCommsQueryInformationFile,
     KphpCommsRequireMedium},
    {KphMsgQueryVolumeInformationFile, KphpCommsQueryVolumeInformationFile,
     KphpCommsRequireMedium},
    ...
    {KphMsgQueryInformationThread, KphpCommsQueryInformationThread,
     KphpCommsQueryInformationThreadRequires},
    ...
    {KphMsgGetMessageSettings, KphpCommsGetMessageSettings,
     KphpCommsRequireLow},
    {KphMsgSetMessageSettings, KphpCommsSetMessageSettings,
     KphpCommsRequireLow},
    {KphMsgAcquireDriverUnloadProtection,
     KphpCommsAcquireDriverUnloadProtection, KphpCommsRequireMaximum},
    {KphMsgReleaseDriverUnloadProtection,
     KphpCommsReleaseDriverUnloadProtection, KphpCommsRequireMaximum},
    {KphMsgGetConnectedClientCount, KphpCommsGetConnectedClientCount,
     KphpCommsRequireLow},
    ...
    {KphMsgRequestSessionAccessToken, KphpCommsRequestSessionAccessToken,
     KphpCommsRequireMaximum},
    {KphMsgAssignProcessSessionToken, KphpCommsAssignProcessSessionToken,
     KphpCommsRequireMaximum},
    {KphMsgAssignThreadSessionToken, KphpCommsAssignThreadSessionToken,
     KphpCommsRequireMaximum},
    {KphMsgGetInformerProcessSettings, KphpCommsGetInformerProcessSettings,
     KphpCommsRequireLow},
    {KphMsgSetInformerProcessSettings, KphpCommsSetInformerProcessSettings,
     KphpCommsRequireLow},
    {KphMsgStripProtectedProcessMasks, KphpCommsStripProtectedProcessMasks,
     KphpCommsRequireMaximum},
    {KphMsgQueryVirtualMemory, KphpCommsQueryVirtualMemory,
     KphpCommsQueryVirtualMemoryRequires},
    {KphMsgQueryHashInformationFile, KphpCommsQueryHashInformationFile,
     KphpCommsRequireMaximum},
    {KphMsgOpenDevice, KphpCommsOpenDevice, KphpCommsRequireMaximum},
    {KphMsgOpenDeviceDriver, KphpCommsOpenDeviceDriver,
     KphpCommsRequireMaximum},
    {KphMsgOpenDeviceBaseDevice, KphpCommsOpenDeviceBaseDevice,
     KphpCommsRequireMaximum},
    ...
    {KphMsgEscalateHandle, KphpCommsEscalateHandle, KphpCommsRequireMaximum},
    {KphMsgWriteVirtualMemory, KphpCommsWriteVirtualMemory,
     KphpCommsRequireMaximum},
};
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsRequireMaximum(_In_ PKPH_CLIENT Client,
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsRequireMedium(_In_ PKPH_CLIENT Client,
                           _In_ PCKPH_MESSAGE Message) {
  KPH_PAGED_CODE_PASSIVE();
  NT_ASSERT(ExGetPreviousMode() == UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsRequireLow(_In_ PKPH_CLIENT Client, _In_ PCKPH_MESSAGE Message) {
  KPH_PAGED_CODE_PASSIVE();
  NT_ASSERT(ExGetPreviousMode() == UserMode);
...
_Function_class_(KPHM_HANDLER)
    ...
    KphpCommsGetInformerSettings(_In_ PKPH_CLIENT Client,
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsSetInformerSettings(_In_ PKPH_CLIENT Client,
                                 _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsOpenProcessRequires(_In_ PKPH_CLIENT Client,
                                 _In_ PCKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenProcess(_In_ PKPH_CLIENT Client,
                         _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenProcess(msg->ProcessHandle, msg->DesiredAccess,
                               msg->ClientId, UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsOpenProcessTokenRequires(_In_ PKPH_CLIENT Client,
                                      _In_ PCKPH_MESSAGE Message) {
  ACCESS_MASK desiredAccess;
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenProcessToken(_In_ PKPH_CLIENT Client,
                              _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenProcessToken(msg->ProcessHandle, msg->DesiredAccess,
                                    msg->TokenHandle, UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsOpenProcessJobRequires(_In_ PKPH_CLIENT Client,
                                    _In_ PCKPH_MESSAGE Message) {
  ACCESS_MASK desiredAccess;
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenProcessJob(_In_ PKPH_CLIENT Client,
                            _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenProcessJob(msg->ProcessHandle, msg->DesiredAccess,
                                  msg->JobHandle, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsTerminateProcess(_In_ PKPH_CLIENT Client,
                              _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status =
      KphTerminateProcess(msg->ProcessHandle, msg->ExitStatus, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsReadVirtualMemory(_In_ PKPH_CLIENT Client,
                               _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status =
      KphReadVirtualMemory(msg->ProcessHandle, msg->BaseAddress, msg->Buffer,
                           msg->BufferSize, msg->NumberOfBytesRead, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsEscalateHandle(_In_ PKPH_CLIENT Client,
                            _Inout_ PKPH_MESSAGE Message) {
  PKPHM_ESCALATE_HANDLE msg;

  KPH_PAGED_CODE_PASSIVE();
  NT_ASSERT(ExGetPreviousMode() == UserMode);
  NT_ASSERT(Message->Header.MessageId == KphMsgEscalateHandle);

  UNREFERENCED_PARAMETER(Client);

  msg = &Message->User.EscalateHandle;

  msg->Status =
      KphEscalateHandleAccess(msg->ProcessHandle, msg->Handle, msg->AccessMask,
                              &msg->NewHandle, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsWriteVirtualMemory(_In_ PKPH_CLIENT Client,
                                _Inout_ PKPH_MESSAGE Message) {
  PKPHM_WRITE_VIRTUAL_MEMORY msg;

  KPH_PAGED_CODE_PASSIVE();
  NT_ASSERT(ExGetPreviousMode() == UserMode);
  NT_ASSERT(Message->Header.MessageId == KphMsgWriteVirtualMemory);

  UNREFERENCED_PARAMETER(Client);

  msg = &Message->User.WriteVirtualMemory;

  msg->Status = KphWriteVirtualMemory(msg->ProcessHandle, msg->BaseAddress,
                                      msg->Buffer, msg->BufferSize,
                                      msg->NumberOfBytesWritten, UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsOpenThreadRequires(_In_ PKPH_CLIENT Client,
                                _In_ PCKPH_MESSAGE Message) {
  ACCESS_MASK desiredAccess;
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenThread(_In_ PKPH_CLIENT Client, _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenThread(msg->ThreadHandle, msg->DesiredAccess,
                              msg->ClientId, UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsOpenThreadProcessRequires(_In_ PKPH_CLIENT Client,
                                       _In_ PCKPH_MESSAGE Message) {
  ACCESS_MASK desiredAccess;
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenThreadProcess(_In_ PKPH_CLIENT Client,
                               _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenThreadProcess(msg->ThreadHandle, msg->DesiredAccess,
                                     msg->ProcessHandle, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsCaptureStackBackTraceThread(_In_ PKPH_CLIENT Client,
                                         _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphCaptureStackBackTraceThreadByHandle(
      msg->ThreadHandle, msg->FramesToSkip, msg->FramesToCapture,
      msg->BackTrace, msg->CapturedFrames, msg->BackTraceHash, msg->Flags,
      msg->Timeout, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsEnumerateProcessHandles(_In_ PKPH_CLIENT Client,
                                     _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphEnumerateProcessHandles(msg->ProcessHandle, msg->Buffer,
                                           msg->BufferLength, msg->ReturnLength,
                                           UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryInformationObject(_In_ PKPH_CLIENT Client,
                                    _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQueryInformationObject(
      msg->ProcessHandle, msg->Handle, msg->ObjectInformationClass,
      msg->ObjectInformation, msg->ObjectInformationLength, msg->ReturnLength,
      UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsSetInformationObject(_In_ PKPH_CLIENT Client,
                                  _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphSetInformationObject(
      msg->ProcessHandle, msg->Handle, msg->ObjectInformationClass,
      msg->ObjectInformation, msg->ObjectInformationLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenDriver(_In_ PKPH_CLIENT Client, _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenDriver(msg->DriverHandle, msg->DesiredAccess,
                              msg->ObjectAttributes, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryInformationDriver(_In_ PKPH_CLIENT Client,
                                    _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQueryInformationDriver(
      msg->DriverHandle, msg->DriverInformationClass, msg->DriverInformation,
      msg->DriverInformationLength, msg->ReturnLength, UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsQueryInformationProcessRequires(_In_ PKPH_CLIENT Client,
                                             _In_ PCKPH_MESSAGE Message) {
  KPH_PAGED_CODE_PASSIVE();
  NT_ASSERT(ExGetPreviousMode() == UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryInformationProcess(_In_ PKPH_CLIENT Client,
                                     _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQueryInformationProcess(
      msg->ProcessHandle, msg->ProcessInformationClass, msg->ProcessInformation,
      msg->ProcessInformationLength, msg->ReturnLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsSetInformationProcess(_In_ PKPH_CLIENT Client,
                                   _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphSetInformationProcess(
      msg->ProcessHandle, msg->ProcessInformationClass, msg->ProcessInformation,
      msg->ProcessInformationLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsSetInformationThread(_In_ PKPH_CLIENT Client,
                                  _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphSetInformationThread(
      msg->ThreadHandle, msg->ThreadInformationClass, msg->ThreadInformation,
      msg->ThreadInformationLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsSystemControl(_In_ PKPH_CLIENT Client,
                           _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status =
      KphSystemControl(msg->SystemControlClass, msg->SystemControlInfo,
                       msg->SystemControlInfoLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsAlpcQueryInformation(_In_ PKPH_CLIENT Client,
                                  _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphAlpcQueryInformation(
      msg->ProcessHandle, msg->PortHandle, msg->AlpcInformationClass,
      msg->AlpcInformation, msg->AlpcInformationLength, msg->ReturnLength,
      UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryInformationFile(_In_ PKPH_CLIENT Client,
                                  _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQueryInformationFile(
      msg->ProcessHandle, msg->FileHandle, msg->FileInformationClass,
      msg->FileInformation, msg->FileInformationLength, msg->IoStatusBlock,
      UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryVolumeInformationFile(_In_ PKPH_CLIENT Client,
                                        _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQueryVolumeInformationFile(
      msg->ProcessHandle, msg->FileHandle, msg->FsInformationClass,
      msg->FsInformation, msg->FsInformationLength, msg->IoStatusBlock,
      UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsDuplicateObject(_In_ PKPH_CLIENT Client,
                             _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status =
      KphDuplicateObject(msg->ProcessHandle, msg->SourceHandle,
                         msg->DesiredAccess, msg->TargetHandle, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryPerformanceCounter(_In_ PKPH_CLIENT Client,
                                     _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->PerformanceCounter =
      KeQueryPerformanceCounter(&msg->PerformanceFrequency);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsCreateFileRequires(_In_ PKPH_CLIENT Client,
                                _In_ PCKPH_MESSAGE Message) {
  ACCESS_MASK desiredAccess;
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsCreateFile(_In_ PKPH_CLIENT Client, _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphCreateFile(
      msg->FileHandle, msg->DesiredAccess, msg->ObjectAttributes,
      msg->IoStatusBlock, msg->AllocationSize, msg->FileAttributes,
      msg->ShareAccess, msg->CreateDisposition, msg->CreateOptions,
      msg->EaBuffer, msg->EaLength, msg->Options, UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsQueryInformationThreadRequires(_In_ PKPH_CLIENT Client,
                                            _In_ PCKPH_MESSAGE Message) {
  KPH_PAGED_CODE_PASSIVE();
  NT_ASSERT(ExGetPreviousMode() == UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryInformationThread(_In_ PKPH_CLIENT Client,
                                    _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQueryInformationThread(
      msg->ThreadHandle, msg->ThreadInformationClass, msg->ThreadInformation,
      msg->ThreadInformationLength, msg->ReturnLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQuerySection(_In_ PKPH_CLIENT Client,
                          _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQuerySection(
      msg->SectionHandle, msg->SectionInformationClass, msg->SectionInformation,
      msg->SectionInformationLength, msg->ReturnLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsCompareObjects(_In_ PKPH_CLIENT Client,
                            _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphCompareObjects(msg->ProcessHandle, msg->FirstObjectHandle,
                                  msg->SecondObjectHandle, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsGetMessageSettings(_In_ PKPH_CLIENT Client,
                                _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsSetMessageSettings(_In_ PKPH_CLIENT Client,
                                _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsAcquireDriverUnloadProtection(_In_ PKPH_CLIENT Client,
                                           _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsReleaseDriverUnloadProtection(_In_ PKPH_CLIENT Client,
                                           _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsGetConnectedClientCount(_In_ PKPH_CLIENT Client,
                                     _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsActivateDynData(_In_ PKPH_CLIENT Client,
                             _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status =
      KphActivateDynData(msg->DynData, msg->DynDataLength, msg->Signature,
                         msg->SignatureLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsIsDynDataActive(_In_ PKPH_CLIENT Client,
                             _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsRequestSessionAccessToken(_In_ PKPH_CLIENT Client,
                                       _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphRequestSessionAccessToken(&msg->AccessToken, &msg->Expiry,
                                             msg->Privileges, msg->Uses);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsAssignProcessSessionToken(_In_ PKPH_CLIENT Client,
                                       _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphAssignProcessSessionToken(msg->ProcessHandle, msg->Signature,
                                             msg->SignatureLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsAssignThreadSessionToken(_In_ PKPH_CLIENT Client,
                                      _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphAssignThreadSessionToken(msg->ThreadHandle, msg->Signature,
                                            msg->SignatureLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsGetInformerProcessSettings(_In_ PKPH_CLIENT Client,
                                        _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphGetInformerProcessSettings(msg->ProcessHandle, msg->Settings,
                                              UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsSetInformerProcessSettings(_In_ PKPH_CLIENT Client,
                                        _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphSetInformerProcessSettings(msg->ProcessHandle, msg->Settings,
                                              UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsStripProtectedProcessMasks(_In_ PKPH_CLIENT Client,
                                        _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status =
      KphStripProtectedProcessMasks(msg->ProcessHandle, msg->ProcessAllowedMask,
                                    msg->ThreadAllowedMask, UserMode);
...
_Function_class_(KPHM_REQUIRED_STATE) _IRQL_requires_max_(PASSIVE_LEVEL)
    _Must_inspect_result_ KPH_PROCESS_STATE KSIAPI
    KphpCommsQueryVirtualMemoryRequires(_In_ PKPH_CLIENT Client,
                                        _In_ PCKPH_MESSAGE Message) {
  KPH_PAGED_CODE_PASSIVE();
  NT_ASSERT(ExGetPreviousMode() == UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryVirtualMemory(_In_ PKPH_CLIENT Client,
                                _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphQueryVirtualMemory(
      msg->ProcessHandle, msg->BaseAddress, msg->MemoryInformationClass,
      msg->MemoryInformation, msg->MemoryInformationLength, msg->ReturnLength,
      UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsQueryHashInformationFile(_In_ PKPH_CLIENT Client,
                                      _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status =
      KphQueryHashInformationFile(msg->FileHandle, msg->HashingInformation,
                                  msg->HashingInformationLength, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenDevice(_In_ PKPH_CLIENT Client, _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenDevice(msg->DeviceHandle, msg->DesiredAccess,
                              msg->ObjectAttributes, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenDeviceDriver(_In_ PKPH_CLIENT Client,
                              _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenDeviceDriver(msg->DeviceHandle, msg->DesiredAccess,
                                    msg->DriverHandle, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsOpenDeviceBaseDevice(_In_ PKPH_CLIENT Client,
                                  _Inout_ PKPH_MESSAGE Message) {
  ...
  msg->Status = KphOpenDeviceBaseDevice(msg->DeviceHandle, msg->DesiredAccess,
                                        msg->BaseDeviceHandle, UserMode);
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsGetInformerStats(_In_ PKPH_CLIENT Client,
                              _Inout_ PKPH_MESSAGE Message) {
...
_Function_class_(KPHM_HANDLER)
    _IRQL_requires_max_(PASSIVE_LEVEL) _Must_inspect_result_ NTSTATUS KSIAPI
    KphpCommsGetMessageStats(_In_ PKPH_CLIENT Client,
                             _Inout_ PKPH_MESSAGE Message) {
