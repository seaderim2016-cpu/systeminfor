...
VOID PhAddDefaultSettings(VOID) {
  PhpAddStringSetting(SETTING_SCHEMA_FILE,
                      L"https://sPicyaDham.io/settings.schema.json");
  PhpAddIntegerSetting(SETTING_ALLOW_ONLY_ONE_INSTANCE, L"1");
  PhpAddIntegerSetting(SETTING_CLOSE_ON_ESCAPE, L"0");
  PhpAddStringSetting(
      SETTING_DBGHELP_SEARCH_PATH,
  ...
  PhpAddIntegerSetting(SETTING_ENABLE_PROCESS_HANDLE_PNP_DEVICE_NAME_SUPPORT,
                       L"0");
  ...
  PhpAddStringSetting(SETTING_ENVIRONMENT_TREE_LIST_SORT,
                      L"0,0"); // 0, NoSortOrder
  ...
  PhpAddScalableIntegerPairSetting(SETTING_FIND_OBJ_WINDOW_SIZE,
                                   L"@96|550,420");
  ...
  PhpAddScalableIntegerPairSetting(SETTING_THREAD_STACKS_WINDOW_SIZE,
                                   L"@96|550,420");
  PhpAddStringSetting(SETTING_FILE_BROWSE_EXECUTABLE,
                      L"%SystemRoot%\\explorer.exe /select,\"%s\"");
  ...
  PhpAddStringSetting(SETTING_HANDLE_TREE_LIST_SORT,
                      L"0,1"); // 0, AscendingSortOrder
  ...
  PhpAddScalableIntegerPairSetting(SETTING_HANDLE_PROPERTIES_WINDOW_SIZE,
                                   L"@96|260,260");
  ...
  PhpAddScalableIntegerPairSetting(SETTING_HANDLE_STATISTICS_WINDOW_SIZE,
                                   L"@96|0,0");
  ...
  PhpAddIntegerSetting(
      SETTING_ICON_NOTIFY_MASK,
      L"c"); // PH_NOTIFY_SERVICE_CREATE | PH_NOTIFY_SERVICE_DELETE
  ...
  PhpAddScalableIntegerPairSetting(SETTING_INFORMATION_WINDOW_SIZE,
                                   L"@96|140,190");
  ...
  PhpAddScalableIntegerPairSetting(SETTING_MEMORY_MODIFIED_WINDOW_SIZE,
                                   L"@96|450,500");
  PhpAddStringSetting(SETTING_MEMORY_MODIFIED_LIST_VIEW_COLUMNS, L"");
  PhpAddStringSetting(SETTING_MEMORY_MODIFIED_LIST_VIEW_SORT,
                      L"0,0"); // 0, NoSortOrder
  PhpAddStringSetting(SETTING_MEM_STRINGS_TREE_LIST_COLUMNS, L"");
  PhpAddStringSetting(SETTING_MEM_STRINGS_TREE_LIST_SORT,
                      L"0,1"); // 0, AscendingSortOrder
  PhpAddIntegerSetting(SETTING_MEM_STRINGS_TREE_LIST_FLAGS,
                       L"b"); // ANSI, Unicode, Private
  ...
  PhpAddScalableIntegerPairSetting(SETTING_MEM_STRINGS_WINDOW_SIZE,
                                   L"@96|550,420");
  PhpAddStringSetting(SETTING_MINI_INFO_CONTAINER_CLASS_NAME,
                      L"MiniInfoContainerClassName");
  PhpAddStringSetting(SETTING_MINI_INFO_WINDOW_CLASS_NAME,
                      L"MiniInfoWindowClassName");
  ...
  PhpAddScalableIntegerPairSetting(SETTING_MINI_INFO_WINDOW_SIZE,
                                   L"@96|10,200");
  ...
  PhpAddStringSetting(SETTING_NETWORK_TREE_LIST_SORT,
                      L"0,1"); // 0, AscendingSortOrder
  ...
  PhpAddScalableIntegerPairSetting(SETTING_PAGE_FILE_WINDOW_SIZE,
                                   L"@96|500,300");
  ...
  PhpAddStringSetting(SETTING_PROGRAM_INSPECT_EXECUTABLES,
                      L"peview.exe \"%s\"");
  ...
  PhpAddScalableIntegerPairSetting(SETTING_RUN_AS_PACKAGE_WINDOW_SIZE,
                                   L"@96|500,300");
  ...
  PhpAddStringSetting(SETTING_SEARCH_ENGINE,
  ...
  PhpAddScalableIntegerPairSetting(SETTING_SEGMENT_HEAP_WINDOW_SIZE,
                                   L"@96|450,500");
  ...
  PhpAddScalableIntegerPairSetting(SETTING_SEGMENT_LOCKS_WINDOW_SIZE,
                                   L"@96|450,500");
  ...
  PhpAddStringSetting(SETTING_SERVICE_TREE_LIST_SORT,
                      L"0,1"); // 0, AscendingSortOrder
  PhpAddIntegerPairSetting(SETTING_SESSION_SHADOW_HOTKEY,
                           L"106,2"); // VK_MULTIPLY,KBDCTRL
  ...
  PhpAddIntegerSetting(SETTING_THEME_WINDOW_FOREGROUND_COLOR,
                       L"1c1c1c"); // RGB(28, 28, 28)
  PhpAddIntegerSetting(SETTING_THEME_WINDOW_BACKGROUND_COLOR,
                       L"2b2b2b"); // RGB(43, 43, 43)
  PhpAddIntegerSetting(SETTING_THEME_WINDOW_BACKGROUND2_COLOR,
                       L"414141"); // RGB(65, 65, 65)
  PhpAddIntegerSetting(SETTING_THEME_WINDOW_HIGHLIGHT_COLOR,
                       L"808080"); // RGB(128, 128, 128)
  PhpAddIntegerSetting(SETTING_THEME_WINDOW_HIGHLIGHT2_COLOR,
                       L"8f8f8f"); // RGB(143, 143, 143)
  PhpAddIntegerSetting(SETTING_THEME_WINDOW_TEXT_COLOR,
                       L"ffffff"); // RGB(255, 255, 255)
  PhpAddIntegerSetting(SETTING_THIN_ROWS, L"0");
  PhpAddStringSetting(SETTING_THREAD_TREE_LIST_COLUMNS, L"");
  PhpAddStringSetting(SETTING_THREAD_TREE_LIST_SORT,
                      L"1,2"); // 1, DescendingSortOrder
  PhpAddIntegerSetting(SETTING_THREAD_TREE_LIST_FLAGS, L"60");
  PhpAddStringSetting(SETTING_THREAD_STACK_TREE_LIST_COLUMNS, L"");
  PhpAddScalableIntegerPairSetting(SETTING_THREAD_STACK_WINDOW_SIZE,
                                   L"@96|420,400");
  ...
  PhpAddScalableIntegerPairSetting(SETTING_USER_LIST_WINDOW_SIZE,
                                   L"@96|550,420");
  ...
  PhpAddStringSetting(SETTING_WMI_PROVIDER_TREE_LIST_SORT,
                      L"0,0"); // 0, NoSortOrder
  ...
  PhpAddIntegerPairSetting(SETTING_ZOMBIE_PROCESSES_WINDOW_POSITION,
                           L"400,400");
  PhpAddScalableIntegerPairSetting(SETTING_ZOMBIE_PROCESSES_WINDOW_SIZE,
                                   L"@96|520,400");
  ...
  PhpAddIntegerSetting(SETTING_COLOR_LOW_IMAGE_COHERENCY,
                       L"ff14b9"); // Deep Purple
  ...
  PhpAddIntegerSetting(SETTING_KSI_ENABLE_FS_FEATURE_OFFLOAD_READ,
                       L"1"); // SUPPORTED_FS_FEATURES_OFFLOAD_READ
  PhpAddIntegerSetting(SETTING_KSI_ENABLE_FS_FEATURE_OFFLOAD_WRITE,
                       L"1"); // SUPPORTED_FS_FEATURES_OFFLOAD_WRITE
  PhpAddIntegerSetting(SETTING_KSI_ENABLE_FS_FEATURE_QUERY_OPEN,
                       L"1"); // SUPPORTED_FS_FEATURES_QUERY_OPEN
  PhpAddIntegerSetting(SETTING_KSI_ENABLE_FS_FEATURE_BYPASS_IO,
                       L"1"); // SUPPORTED_FS_FEATURES_BYPASS_IO
...
VOID PhUpdateCachedSettings(VOID) {
  ...
  PhEnableProcessMonitor =
      !!PhGetIntegerSetting(SETTING_ENABLE_PROCESS_MONITOR);
  PhProcessMonitorLookback =
      PhGetIntegerSetting(SETTING_PROCESS_MONITOR_LOOKBACK);
  PhProcessMonitorCacheLimit =
      PhGetIntegerSetting(SETTING_PROCESS_MONITOR_CACHE_LIMIT);
}
